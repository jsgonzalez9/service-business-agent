...
Seller counter offer: $${l.counterOfferAmount}`.trim(),y.offer_amount=Number(l.counterOfferAmount));try{let{scoreLead:a}=await e.A(54934);y.score=a(t,u),y.score_updated_at=new Date().toISOString()}catch{}l.offerAccepted||l.readyForContract?d="offer_accepted":l.shouldMakeOffer&&"offer_made"!==t.conversation_state?d="offer_made":l.suggestedState&&(d=l.suggestedState),l.extractedInfo?.mortgageOwed&&(y.mortgage_owed=Number(l.extractedInfo.mortgageOwed));let w=l.callIntent||{action:"none"};(l.shouldMakeOffer||l.readyForContract)&&t.arv&&t.repair_estimate&&(y.offer_amount=function(e,t,a,r=.7){return Math.max(0,Math.round(e*r-t-a))}(t.arv,t.repair_estimate,s.wholesaling_fee,s.arv_multiplier));try{let{enforceRails:a,mao:r}=await e.A(23608),n=r(t.arv||0,t.repair_estimate||0,s.wholesaling_fee,s.arv_multiplier),o=a(t,n,y.offer_amount||void 0);!o.allowed&&o.nextAmount&&(y.offer_amount=o.nextAmount)}catch{}return{message:l.smsResponse,updatedLead:y,newState:d,modelUsed:"gpt-5.1",escalated:p,callIntent:w}}async function u(e,t){return`Hi ${e.name}, this is ${t.company_name}. Are you still interested in selling ${e.address}? We make fair cash offers and can close quickly. Reply YES if you'd like to learn more!`}async function p(e,t){switch(e.conversation_state){case"contacted":return`Hi ${e.name}, just following up on my message about ${e.address}. We're still interested in making you a fair cash offer. Let me know if you have any questions!`;case"offer_made":return`Hi ${e.name}, just checking if you had a chance to consider our offer of $${e.offer_amount?.toLocaleString()} for ${e.address}. Let me know your thoughts!`;case"contract_sent":return`Hi ${e.name}, just checking if you had a chance to review the contract for ${e.address}. Let me know if you have any questions!`;default:return`Hi ${e.name}, this is ${t.company_name} following up about ${e.address}. Are you still interested in selling? We'd love to help!`}}e.s(["generateAgentResponse",()=>d,"generateFollowUp",()=>p,"generateInitialOutreach",()=>u,"getAgentConfig",()=>l])},44446,e=>{"use strict";var t=e.i(55454),a=e.i(78872),r=e.i(51045),n=e.i(17396),o=e.i(37276),s=e.i(63400),i=e.i(51826),l=e.i(52747),c=e.i(59428),d=e.i(81124),u=e.i(46569),p=e.i(21392),f=e.i(12613),m=e.i(2254),_=e.i(7707),h=e.i(55431),g=e.i(93695);e.i(33109);var y=e.i(30833),w=e.i(61760),v=e.i(89660),S=e.i(54233),x=e.i(32721),R=e.i(16303),I=e.i(55156);async function E(e){try{var t,a;let r,{leadId:n,contractLink:o,role:s}=await e.json();if(!n)return w.NextResponse.json({error:"Lead ID required"},{status:400});let i=await (0,v.createClient)(),l=await (0,R.getAgentConfig)(),{data:c,error:d}=await i.from("leads").select("*").eq("id",n).single();if(d||!c)return w.NextResponse.json({error:"Lead not found"},{status:404});let u=o||"";try{if(!u){let e=(0,I.createServiceClient)(),t=c.state||function(e){try{let t=e.split(",").map(e=>e.trim()),a=(t[t.length-1]||"").match(/\b([A-Z]{2})\b/);return a?a[1]:null}catch{return null}}(c.address||"")||null,a=e.from("contract_templates").select("*").eq("role",String(s||"seller"));t&&(a=a.eq("state",t));let{data:r}=await a.order("created_at",{ascending:!1}).limit(1),n=r?.[0];if(n&&n.storage_path){let t=await e.storage.from("contracts").download(n.storage_path);if(t.data){let a=n.storage_path.split("/").pop()||"contract.pdf",r=`instances/${c.id}/${Date.now()}-${a}`;if(!(await e.storage.from("contracts").upload(r,t.data,{cacheControl:"3600",upsert:!1})).error){let t=await e.storage.from("contracts").createSignedUrl(r,900);!t.error&&t.data?.signedUrl&&(u=t.data.signedUrl,await e.from("contract_instances").insert({lead_id:c.id,template_id:n.id,storage_path:r,status:"sent"}),await e.from("leads").update({contract_link:u,conversation_state:"contract_sent"}).eq("id",c.id))}}}}}catch{}u||(t=c,a=l.company_name,r=new URLSearchParams({name:t.name,address:t.address,offer:t.offer_amount?.toString()||"",company:a}),u=`https://your-docusign-url.com/sign?${r.toString()}`);let p=`Great news, ${c.name}! I've prepared the contract for ${c.address} at $${c.offer_amount?.toLocaleString()}. You can review and sign here: ${u}`,{sid:f,error:m}=await (0,x.sendSMS)(c.phone_number,p);if(m)return w.NextResponse.json({error:m},{status:500});return await (0,S.saveMessage)({lead_id:c.id,direction:"outbound",content:p,twilio_sid:f||void 0}),await (0,S.updateLead)(c.id,{conversation_state:"contract_sent",contract_link:u,last_message_at:new Date().toISOString()}),w.NextResponse.json({success:!0,contractLink:u,messageSid:f})}catch(e){return console.error("Error sending contract:",e),w.NextResponse.json({error:"Failed to send contract"},{status:500})}}e.s(["POST",()=>E],44241);var b=e.i(44241);let A=new t.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/send-contract/route",pathname:"/api/send-contract",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/send-contract/route.ts",nextConfigOutput:"",userland:b}),{workAsyncStorage:O,workUnitAsyncStorage:C,serverHooks:T}=A;function N(){return(0,r.patchFetch)({workAsyncStorage:O,workUnitAsyncStorage:C})}async function $(e,t,r){A.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let w="/api/send-contract/route";w=w.replace(/\/index$/,"")||"/";let v=await A.prepare(e,t,{srcPage:w,multiZoneDraftMode:!1});if(!v)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:S,params:x,nextConfig:R,parsedUrl:I,isDraftMode:E,prerenderManifest:b,routerServerContext:O,isOnDemandRevalidate:C,revalidateOnlyGenerated:T,resolvedPathname:N,clientReferenceManifest:$,serverActionsManifest:k}=v,M=(0,l.normalizeAppPath)(w),L=!!(b.dynamicRoutes[M]||b.routes[N]),P=async()=>((null==O?void 0:O.render404)?await O.render404(e,t,I,!1):t.end("This page could not be found"),null);if(L&&!E){let e=!!b.routes[N],t=b.dynamicRoutes[M];if(t&&!1===t.fallback&&!e){if(R.experimental.adapterPath)return await P();throw new g.NoFallbackError}}let j=null;!L||A.isDev||E||(j="/index"===(j=N)?"/":j);let q=!0===A.isDev||!L,U=L&&!q;k&&$&&(0,s.setReferenceManifestsSingleton)({page:w,clientReferenceManifest:$,serverActionsManifest:k,serverModuleMap:(0,i.createServerModuleMap)({serverActionsManifest:k})});let D=e.method||"GET",F=(0,o.getTracer)(),H=F.getActiveScopeSpan(),W={params:x,prerenderManifest:b,renderOpts:{experimental:{authInterrupts:!!R.experimental.authInterrupts},cacheComponents:!!R.cacheComponents,supportsDynamicResponse:q,incrementalCache:(0,n.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:R.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,r)=>A.onRequestError(e,t,r,O)},sharedContext:{buildId:S}},Y=new c.NodeNextRequest(e),G=new c.NodeNextResponse(t),K=d.NextRequestAdapter.fromNodeNextRequest(Y,(0,d.signalFromNodeResponse)(t));try{let s=async e=>A.handle(K,W).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=F.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==u.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${D} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${D} ${w}`)}),i=!!(0,n.getRequestMeta)(e,"minimalMode"),l=async n=>{var o,l;let c=async({previousCacheEntry:a})=>{try{if(!i&&C&&T&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let o=await s(n);e.fetchMetrics=W.renderOpts.fetchMetrics;let l=W.renderOpts.pendingWaitUntil;l&&r.waitUntil&&(r.waitUntil(l),l=void 0);let c=W.renderOpts.collectedTags;if(!L)return await (0,f.sendResponse)(Y,G,o,W.renderOpts.pendingWaitUntil),null;{let e=await o.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(o.headers);c&&(t[h.NEXT_CACHE_TAGS_HEADER]=c),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==W.renderOpts.collectedRevalidate&&!(W.renderOpts.collectedRevalidate>=h.INFINITE_CACHE)&&W.renderOpts.collectedRevalidate,r=void 0===W.renderOpts.collectedExpire||W.renderOpts.collectedExpire>=h.INFINITE_CACHE?void 0:W.renderOpts.collectedExpire;return{value:{kind:y.CachedRouteKind.APP_ROUTE,status:o.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==a?void 0:a.isStale)&&await A.onRequestError(e,t,{routerKind:"App Router",routePath:w,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:U,isOnDemandRevalidate:C})},O),t}},d=await A.handleResponse({req:e,nextConfig:R,cacheKey:j,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:b,isRoutePPREnabled:!1,isOnDemandRevalidate:C,revalidateOnlyGenerated:T,responseGenerator:c,waitUntil:r.waitUntil,isMinimalMode:i});if(!L)return null;if((null==d||null==(o=d.value)?void 0:o.kind)!==y.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==d||null==(l=d.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});i||t.setHeader("x-nextjs-cache",C?"REVALIDATED":d.isMiss?"MISS":d.isStale?"STALE":"HIT"),E&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let u=(0,m.fromNodeOutgoingHttpHeaders)(d.value.headers);return i&&L||u.delete(h.NEXT_CACHE_TAGS_HEADER),!d.cacheControl||t.getHeader("Cache-Control")||u.get("Cache-Control")||u.set("Cache-Control",(0,_.getCacheControlHeader)(d.cacheControl)),await (0,f.sendResponse)(Y,G,new Response(d.value.body,{headers:u,status:d.value.status||200})),null};H?await l(H):await F.withPropagatedContext(e.headers,()=>F.trace(u.BaseServerSpan.handleRequest,{spanName:`${D} ${w}`,kind:o.SpanKind.SERVER,attributes:{"http.method":D,"http.target":e.url}},l))}catch(t){if(t instanceof g.NoFallbackError||await A.onRequestError(e,t,{routerKind:"App Router",routePath:M,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:U,isOnDemandRevalidate:C})}),L)throw t;return await (0,f.sendResponse)(Y,G,new Response(null,{status:500})),null}}e.s(["handler",()=>$,"patchFetch",()=>N,"routeModule",()=>A,"serverHooks",()=>T,"workAsyncStorage",()=>O,"workUnitAsyncStorage",()=>C],44446)},83768,e=>{e.v(t=>Promise.all(["server/chunks/lib_cache-router_ts_c67d7e26._.js"].map(t=>e.l(t))).then(()=>t(84204)))},56504,e=>{e.v(t=>Promise.all(["server/chunks/lib_llm-cache_ts_f9e4bce6._.js"].map(t=>e.l(t))).then(()=>t(15794)))},54934,e=>{e.v(t=>Promise.all(["server/chunks/lib_scoring_ts_dbd9e788._.js"].map(t=>e.l(t))).then(()=>t(77618)))},23608,e=>{e.v(t=>Promise.all(["server/chunks/lib_negotiation-rails_ts_f535b509._.js"].map(t=>e.l(t))).then(()=>t(23875)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__3b3a6e1b._.js.map